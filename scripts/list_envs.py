...
All the environments are registered in the `Franka_End_Effector_Tracking` extension. They start
...
def main():
    """Print all environments registered in `Franka_End_Effector_Tracking` extension."""
