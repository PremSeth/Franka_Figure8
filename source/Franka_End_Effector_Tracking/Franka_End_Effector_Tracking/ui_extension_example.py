...
def some_public_function(x: int):
    print("[Franka_End_Effector_Tracking] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[Franka_End_Effector_Tracking] startup")
    ...
    def on_shutdown(self):
        print("[Franka_End_Effector_Tracking] shutdown")